...
const CreateCar = () => {
    ...
    const handleImageChange = (e) => {
        ...
        setProductPictures((prevPictures) => [...prevPictures, ...files].slice(0, 5));
    };
                                    ...
                                    <div className='mb-3'>
                                        <div className='d-flex flex-wrap'>
                                            ...
                                            {productPictures.length < 5 && (
                                                <label className='btn btn-outline-primary m-2' style={{ width: '100px', height: '100px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
