                ...
                <div className="row" style={{ marginBottom: '100px', marginTop: '-40px' }}>
                    ...
                    {Array.isArray(brand.carInvoleInThisBrand) ? (
                        brand.carInvoleInThisBrand.map((p) => (
                            console.log('hm', p.productPictures[0]),
                            console.log(process.env.REACT_APP_API_URL+p.productPictures[1]),
                            console.log(process.env.REACT_APP_API_URL+p.productPictures[2]),
                            console.log(process.env.REACT_APP_API_URL+p.productPictures[3]),
                            console.log(process.env.REACT_APP_API_URL+p.productPictures[4]),
                                    ...
                                    <div className="d-flex justify-content-between p-3">
                                        ...
                                        <div
                                            ...
                                            <p className="text-white mb-0 small">
                                                <img src={process.env.REACT_APP_API_URL+brand.brandPictures[0]} alt={brand.name} style={{ maxWidth: '100%', maxHeight: '150px', objectFit: 'contain' }} />
                                            </p>
                                        </div>
                                    </div>
