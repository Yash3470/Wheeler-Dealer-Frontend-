            ...
            {loading ?
                ...
                <div className="row">
                    <div className="col-md-6 text-center">
                        <ReactImageTurntable
                            images={car.productPictures.map(picture => `${process.env.REACT_APP_API_URL}${picture}`)}
                                    ...
                                    <div className="col-md-12 col-lg-3 mb-3 mb-lg-0 my-3" key={p._id}>
                                        <div className="card">
                                            ...
                                            <Link to={`/car/${p.slug}`} className='text-center'>
                                                <img src={`${process.env.REACT_APP_API_URL}${p.productPictures[4]}`} alt={p.name} style={{ maxWidth: '100%', maxHeight: '120px', objectFit: 'contain' }} className='border rounded' />
                                            </Link>
