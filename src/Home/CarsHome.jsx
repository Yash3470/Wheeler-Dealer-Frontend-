                                    ...
                                    <div className="d-flex justify-content-between p-3">
                                        ...
                                        <div
                                            ...
                                            <Link to={`/brand/${p.brand.slug}`} className="text-white mb-0 small">
                                                <img src={ p.brand?.brandPictures
      ? `${process.env.REACT_APP_API_URL}${p.brand.brandPictures}`
      : '/default-image.jpg'} alt={p.brand.name} style={{ maxWidth: '100%', maxHeight: '150px', objectFit: 'contain' }} />
                                            </Link>
                                        </div>
                                    </div>
                                    ...
                                    <img
                                        src={
                                             ...
                                             ? `${process.env.REACT_APP_API_URL}${p.productPictures[0]}`
                                             : '/default-image.jpg'
